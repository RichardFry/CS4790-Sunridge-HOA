...
namespace SunridgeHOA.Migrations
{
    ...
    [Migration("20201115215410_adding_Board_members")]
    partial class adding_Board_members
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SunridgeHOA.Areas.Admin.Models.BoardMember", b =>
                {
                    b.Property<int>("BoardMemberId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("BoardPosition")
                        .IsRequired();
            ...
            modelBuilder.Entity("SunridgeHOA.Models.File", b =>
                {
                    b.HasOne("SunridgeHOA.Models.FormResponse")
                        .WithMany("Files")
                        .HasForeignKey("FormResponseId");
